...
experiments = ["(a)_SGD_lr_0.001", "(a)_SGD_lr_0.005",
               "(a)_SGD_lr_0.0025", "(a)_SVRG_lr_0.025"]

data_dir = "outputs/b/(a)"
...
plt.ylim(0, 0.5)
plt.title("B(a)  MNIST convex: training loss: P(w)", fontsize=15)
plt.xlabel("Epoch")
...
plt.savefig(os.path.join(output_dir, "B(a) mnist_lr_search_train_loss.png"))
plt.show()